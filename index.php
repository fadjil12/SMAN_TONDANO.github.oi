...
<html lang="en" id="home">
  <head>
    ...
    <title>KANTIN SEKOLAH SMAN 1 TONDANO</title>
  ...
  <body>
    ...
    if($id_login==""){?>
      ...
      <div class="jumbotron text-center">
        ...
        <h1 class="textWarning">Kantin Sehat SMAN 1 TONDANO</h1>
        <p class="kopi">Kantinnya Anak Muda Gaul </p>
      </div>
      <!-- Akhir Jumbtron -->
      <?php 
    }?>
    ...
    if($id_login==""){?>
      ...
      <section class="about" id="about">
        <div class="container-fluid imgAbout">
          ...
          <div class="row mt-3">
            <div class="col-md-6">
              <p class="pKiri">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INI MERUPAKAN SEBUAT WEB YANG KAMI BANGUN BERSAMA DENGAN NAMA KELOMPOK : I KADEK WEDHIANA,SHAVENCO BLASIUS RAMPENGAN, DAN EUNIKA HANA PESIK. <br>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <p class="footer">&copy; Copyright <?= date('Y'); ?> | KANTIN SMAN 1 TONDANO</p>
          </div>
        </div>
      </div>
    </footer>
